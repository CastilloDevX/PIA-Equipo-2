...
import com.pia.piaequipo2.utils.suspendUser
import com.pia.piaequipo2.R

@Composable
fun SuspendUsersScreen() {
    ...
    Column(Modifier.padding(16.dp)) {
        ...
        Text(stringResource(R.string.suspend_user), style = MaterialTheme.typography.headlineMedium)
        ...
        filteredUsers.forEach { (uid, name, email) ->
            Row(
                ...
                Button(onClick = {
                    suspendUser(uid, 30)
                    Toast.makeText(context, context.getString(R.string.suspend_by_time, name), Toast.LENGTH_SHORT).show()
                }) {
